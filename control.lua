...
script.on_event(defines.events.on_player_left_game, Gui.on_player_context_lost)
script.on_event(defines.events.on_player_died, Gui.on_player_context_lost)
script.on_event(defines.events.on_player_controller_changed, Gui.on_player_context_lost)
